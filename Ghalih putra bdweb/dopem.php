...
<tr valign=middle height=19 >
	...
	<td align=left><font face=verdana size=1 class="yellowblack"><b><?php echo $data['nid'];?></b></font></td>

	<td align=center>
		<a href="form_editdopem.php?id=<?php echo $data['nim'];?>" style="text-decoration:none">
		<img src="ceklist2.jpg" width="13"></a>&nbsp;
		<a href="form_deldopem.php?id=<?php echo $data['nim'];?>" style="text-decoration:none">
...
<tr valign=middle height=19>
	<td colspan=3>&nbsp;</td>
	<td align="center">
		<a href="form_adddopem.php" style="text-decoration:none"><img src="plus3.jpg" width="25"></a>
	</td>
</tr>
</table>
